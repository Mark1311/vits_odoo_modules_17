...
###############################################################################
{
    'name': 'Advance Hide Tracking Number',
    'version': '17.1.1',
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            'tracking_number_hide_pro/static/src/xml/inherit_receipt_header.xml',
            'tracking_number_hide_pro/static/src/xml/inherit_order_receipt.xml',
        ],
    },
